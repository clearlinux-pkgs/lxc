...
Source0  : https://linuxcontainers.org/downloads/lxc/lxc-6.0.4.tar.gz
Source1  : https://linuxcontainers.org/downloads/lxc/lxc-6.0.4.tar.gz.asc
...
%description
This directory must exist, even though it may be empty.
It is used to temporary mount the rootfs of lxc in a private
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743781887
